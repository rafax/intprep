...
import com.gajdulewicz.intprep.cf.LinkedLists.*;
...
import static com.gajdulewicz.intprep.cf.LinkedLists.*;
...
public class LinkedListsTest {
  ...
  public void removeKFromListTest() {
    ...
    Truth.assertThat(arr(removeKFromList(list(1, 2, 3, 3), 3))).isEqualTo(new int[] {1, 2});
  }

  @Test
  public void isListPalindromeTest() {
    Truth.assertThat(isListPalindrome(list(1, 2, 3, 2, 1))).isTrue();
    Truth.assertThat(isListPalindrome(list(1, 2, 3, 2, 2))).isFalse();
  }

  @Test
  public void addTwoHugeNumbersTest() {
    Truth.assertThat(arr(addTwoHugeNumbers(list(9876, 5432, 1999), list(1, 8001))))
